...
class ProcessoControllerTest {
    ...
    void testSaveProcessoAlreadyExists() throws Exception {
        ...
        when(processoService.saveProcesso(any(Processo.class)))
    ...
    void testGetAllProcessos() throws Exception {
        ...
        when(processoService.getAllProcessos()).thenReturn(Arrays.asList(processo1, processo2));
    ...
    void testGetProcessoByIdNotFound() throws Exception {
        when(processoService.getProcessoById(1L))
    ...
    void testDeleteProcessoNotFound() throws Exception {
        doThrow(new ProcessoNotFoundException(1L)).when(processoService).deleteProcesso(1L);
